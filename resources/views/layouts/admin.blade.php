...
<head>
    ...
    <style>
        ...
        .sidebar a { color: #D1D5DB; padding: .7rem 1.2rem; display: flex; align-items: center; gap: .6rem; border-radius: .5rem; margin: 0 .6rem; font-size: .92rem; }
        .sidebar a:hover, .sidebar a.active { background: #FF5722; color: #fff; text-decoration: none; }
        .brand { color: #fff; font-weight: 800; font-size: 1.3rem; padding: 1.2rem; }
        .brand span { color: #FF5722; }
        .card-stat { border: none; border-radius: 1rem; box-shadow: 0 2px 10px rgba(0,0,0,.04); }
...
<div class="d-flex">
    <aside class="sidebar" id="sidebar">
        <div class="brand">Market<span>Ku</span> <small class="d-block text-white-50 fs-6 fw-normal">Admin Panel</small></div>
